 ...
 * @method static JsonResponse responseSuccess(array $data, string|null $message = null)
 * @method static JsonResponse responseError(string $message, array $data = [], int|null $code = null, int $status = 200)
 ...
 * @method static mixed uploadFromEditor(Request $request, string|int|null $folderId = 0, $folderName = null, string $fileInput = 'upload')
 ...
 * @method static array uploadFromBlob(UploadedFile $path, string|null $fileName = null, string|int $folderId = 0, string|null $folderSlug = null)
