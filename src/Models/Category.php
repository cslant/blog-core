 ...
 * @method static Builder<Category>|Category first()
 * @method static Builder<Category>|Category find($id)
 * @method static Builder<Category>|Category with($relations)
 * @method static Builder<Category>|Category whereId($value)
 * @method static Builder<Category>|Category whereIn($column, $values)
 * @method static Builder<Category>|Category where($column, $operator = null, $value = null, $boolean = 'and')
